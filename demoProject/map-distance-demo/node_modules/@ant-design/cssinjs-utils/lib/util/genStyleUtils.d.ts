...
import type { ComponentTokenKey, GlobalTokenWithComponent, TokenMap, TokenMapKey } from '@ant-design/cssinjs-utils/lib/interface';
...
declare function genStyleUtils<CompTokenMap extends TokenMap, AliasToken extends TokenType, DesignToken extends TokenType>(config: {
    ...
    genComponentStyleHook: <C_1 extends TokenMapKey<CompTokenMap>>(componentName: C_1 | [C_1, string], styleFn: GenStyleFn<CompTokenMap, AliasToken, C_1>, getDefaultToken?: GetDefaultToken<CompTokenMap, AliasToken, C_1>, options?: {
        resetStyle?: boolean;
        resetFont?: boolean;
        deprecatedTokens?: [keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface/components").OverrideTokenMap<CompTokenMap, AliasToken>[C_1], undefined>, keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface/components").OverrideTokenMap<CompTokenMap, AliasToken>[C_1], undefined>][];
        /**
         * Only use component style in client side. Ignore in SSR.
         */
        clientOnly?: boolean;
        ...
        order?: number;
        injectStyle?: boolean;
        unitless?: Partial<Record<keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface/components").OverrideTokenMap<CompTokenMap, AliasToken>[C_1], undefined>, boolean>>;
