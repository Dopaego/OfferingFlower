...
import { type ComponentsType, type NotificationClassNames as NoticeClassNames, type NotificationProps, type NotificationStyles as NoticeStyles } from '@rc-component/notification/es/Notification';
export type Placement = 'top' | 'topLeft' | 'topRight' | 'bottom' | 'bottomLeft' | 'bottomRight';
export type { StackConfig } from '@rc-component/notification/es/hooks/useStack';
