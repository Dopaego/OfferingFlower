...
import type { RangePickerProps as BaseRangePickerProps, DatePickerSemanticType, PickerProps, PickerPropsWithMultiple } from 'antd/es/date-picker/generatePicker/interface';
...
declare const DatePicker: (<ValueType = Dayjs, IsMultiple extends boolean = false>(props: PickerPropsWithMultiple<Dayjs, PickerProps<Dayjs>, ValueType, IsMultiple>) => React.ReactElement) & {
    ...
    TimePicker: (<ValueType = Dayjs, IsMultiple extends boolean = false>(props: PickerPropsWithMultiple<Dayjs, Omit<import("antd/es/date-picker/generatePicker/interface").GenericTimePickerProps<Dayjs>, "picker">, ValueType, IsMultiple>) => React.ReactElement) & {
        displayName?: string;
    };
