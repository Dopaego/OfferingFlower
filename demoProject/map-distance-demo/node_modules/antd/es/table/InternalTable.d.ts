...
import type { GenerateSemantic } from 'antd/es/_util/hooks/useMergeSemantic/semanticType';
import type { AnyObject } from 'antd/es/_util/type';
import type { SizeType } from 'antd/es/config-provider/SizeContext';
import type { PaginationSemanticType } from 'antd/es/pagination/Pagination';
import type { SpinProps } from 'antd/es/spin';
import type { ColumnsType, ColumnType, FilterValue, GetPopupContainer, RefInternalTable, SorterResult, SorterTooltipProps, SortOrder, TableCurrentDataSource, TableLocale, TablePaginationConfig, TableRowSelection } from 'antd/es/table/interface';
