...
import type { TransferCustomListBodyProps, TransferListProps } from 'antd/es/transfer/Section';
export type { TransferOperationProps } from 'antd/es/transfer/Actions';
export type { TransferSearchProps } from 'antd/es/transfer/search';
export type { TransferListProps } from 'antd/es/transfer/Section';
...
declare const Transfer: {
    ...
    Operation: React.FC<import("antd/es/transfer/Actions").TransferOperationProps>;
};
