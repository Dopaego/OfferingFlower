...
import type { Variant } from 'antd/lib/config-provider';
import type { SizeType } from 'antd/lib/config-provider/SizeContext';
import type { SelectSemanticType } from 'antd/lib/select';
...
declare const PurePanel: (props: import("antd/lib/_util/type").AnyObject) => React.JSX.Element;
