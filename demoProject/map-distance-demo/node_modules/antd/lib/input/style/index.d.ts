...
import type { GenerateStyle } from 'antd/lib/theme/internal';
import type { ComponentToken, InputToken } from 'antd/lib/input/style/token';
import { initComponentToken, initInputToken } from 'antd/lib/input/style/token';
