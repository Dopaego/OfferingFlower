import type { SharedComponentToken, SharedInputToken } from 'antd/lib/input/style/token';
import type { FullToken, GenStyleFn, GetDefaultToken } from 'antd/lib/theme/internal';
