...
import type { GenerateSemantic } from 'antd/lib/_util/hooks/useMergeSemantic/semanticType';
import type { InputStatus } from 'antd/lib/_util/statusUtils';
import type { PaginationType, TransferKey } from 'antd/lib/transfer/interface';
import type { TransferCustomListBodyProps, TransferListProps } from 'antd/lib/transfer/Section';
export type { TransferOperationProps } from 'antd/lib/transfer/Actions';
export type { TransferSearchProps } from 'antd/lib/transfer/search';
export type { TransferListProps } from 'antd/lib/transfer/Section';
...
declare const Transfer: {
    ...
    Search: React.FC<import("antd/lib/transfer/search").TransferSearchProps>;
    Operation: React.FC<import("antd/lib/transfer/Actions").TransferOperationProps>;
};
